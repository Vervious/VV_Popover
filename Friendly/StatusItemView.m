//
//
//  Attributed to Vadim Shpakovski
...
{
    self.referencePoint = NSMakePoint(NSMidX(self.screenRect),
    ...
    [icon drawAtPoint:iconPoint fromRect:NSZeroRect operation:NSCompositeSourceOver fraction:1];
}
